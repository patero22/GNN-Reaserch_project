...
def visualize_comparison(data1, data2, labels=['Data1', 'Data2'], title='Porównanie danych'):
    '''
    Funkcja do wizualizacji porównania dwóch zbiorów danych.
    data1, data2: listy lub tablice numpy z danymi
    labels: etykiety dla danych
    title: tytuł wykresu
    '''
    x = np.arange(len(data1))
    
    plt.figure(figsize=(10, 6))
    plt.plot(x, data1, label=labels[0], marker='o')
    plt.plot(x, data2, label=labels[1], marker='x')
    plt.fill_between(x, data1, data2, color='gray', alpha=0.2, step="mid")
...
# visualize_comparison([1, 2, 3, 4], [4, 3, 2, 1])
